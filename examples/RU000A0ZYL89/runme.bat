...
rem --- run model ---
python runner.py -p="C:\CFM_Public\examples\RU000A0ZYL89\run_params.json" -m=NumberOfMonteCarloScenarios=10 -m=RandomNumberSeed=123456 --dumpdir="C:\CFM_Public\examples\RU000A0ZYL89"
